...
public class Fac {
    ...
    static ast.Ast.Class.T fac = new ast.Ast.Class.ClassSingle("Fac", null, new util.Flist<Dec.T>().list(),
            new util.Flist<Method.T>()
                    .list(new Method.MethodSingle(new Type.Int(), "ComputeFac",
                            new util.Flist<Dec.T>().list(new Dec.DecSingle(new Type.Int(), "num", lineNum)),
                            new util.Flist<Dec.T>().list(new Dec.DecSingle(new Type.Int(), "num_aux", lineNum)),
                            new util.Flist<Stm.T>()
                                    .list(new If(new Lt(new Id("num", lineNum), new Num(1, lineNum), lineNum),
                                            new Assign("num_aux", new Num(1, lineNum), lineNum),
                                            new Assign("num_aux",
                                                    new Times(new Id("num", lineNum), new Call(new This(), "ComputeFac",
                                                            new util.Flist<Exp.T>().list(new Sub(new Id("num", lineNum),
                                                                    new Num(1, lineNum), lineNum)),
                                                            lineNum), lineNum),
                                                    lineNum),
                                            lineNum)),
    ...
    // Your code here:
    static MainClass.T sum = new MainClassSingle("Sum", "a", new Print(new Call(new NewObject("Doit", lineNum), "doit",
            new util.Flist<Exp.T>().list(new Num(101, lineNum)), lineNum), lineNum), lineNum);
    static ast.Ast.Class.T doit = new ast.Ast.Class.ClassSingle("Doit", null, new util.Flist<Dec.T>().list(),
            new util.Flist<Method.T>()
                    .list(new Method.MethodSingle(new Type.Int(), "doit",
                            ...
                            new util.Flist<Stm.T>()
                                    .list(new Assign("i", new Num(0, lineNum), lineNum),
                                            new Assign("sum", new Num(0, lineNum), lineNum),
                                            new While(new Lt(new Id("i", lineNum), new Id("n", lineNum), lineNum),
                                                    new Block(new util.Flist<Stm.T>().list(
                                                            new Assign("sum",
                                                                    new Add(new Id("sum", lineNum),
                                                                            new Id("i", lineNum), lineNum),
                                                                    lineNum),
                                                            new Assign("i",
                                                                    new Add(new Id("i", lineNum), new Num(1, lineNum),
                                                                            lineNum),
                                                                    lineNum)),
                                                            lineNum),
                                                    lineNum)),
