...
public class Ast {
  ...
  public static class Method {
    ...
    public static class MethodSingle extends T {
      ...
      public MethodSingle(Type.T retType, String id, LinkedList<Dec.T> formals, LinkedList<Dec.T> locals,
          LinkedList<Stm.T> stms, Exp.T retExp, int lineNum) {
        this.lineNum = lineNum;
  ...
  public static class Class {
    ...
    public static class ClassSingle extends T {
      ...
      public ClassSingle(String id, String extendss, java.util.LinkedList<Dec.T> decs,
          java.util.LinkedList<ast.Ast.Method.T> methods, int lineNum) {
        this.lineNum = lineNum;
        this.id = id;
  ...
  public static class MainClass {
    ...
    public static class MainClassSingle extends T {
      ...
      public MainClassSingle(String id, String arg, Stm.T stm, int lineNum) {
        this.lineNum = lineNum;
        this.id = id;
        this.arg = arg;
        this.stm = stm;
