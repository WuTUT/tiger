...
public class PrettyPrintVisitor implements Visitor {
  ...
  public void visit(MethodSingle m) {
    ...
    this.sayln("char *" + m.id + "_arguments_gc_map=\"" + arguments_gc_maps.toString() + "\";");
    this.sayln("char *" + m.id + "_locals_gc_map=\"" + locals_gc_maps.toString() + "\";");
    this.sayln("struct " + m.id
    ...
    this.sayln("  frame.arguments_gc_map = " + m.id + "_arguments_gc_map;");
    this.sayln("  frame.arguments_base_address = &this;");
    this.sayln("  frame.locals_gc_map = " + m.id + "_locals_gc_map;");
    for (Dec.T d : m.locals) {
      DecSingle dec = (DecSingle) d;
      if (!(dec.type instanceof Type.ClassType) && !(dec.type instanceof Type.IntArray)) {
        this.say("  ");
