...
public class CommandLine {
  ...
  public CommandLine() {
    this.args = new util.Flist<Arg<Object>>().list(
        new Arg<Object>("codegen", "{bytecode|C|dalvik|x86}", "which code generator to use", Kind.String, (ss) -> {
          String s = (String) ss;
          ...
          return;
        }), new Arg<Object>("dump", "<ir>", "dump information about the ir", Kind.String, new F<Object>() {
          @Override
        ...
        }), new Arg<Object>("output", "<outfile>", "set the name of the output file", Kind.String, (Object s) -> {
          Control.ConCodeGen.outputName = (String) s;
          return;
        }), new Arg<Object>("skip", "<pass>", "which compile pass to skip", Kind.String, (s) -> {
          Control.addPass((String) s);
          return;
        }),
        new Arg<Object>("testFac", null, "whether or not to test the Tiger compiler on Fac.java", Kind.Empty, (s) -> {
          ...
          return;
        }), new Arg<Object>("trace", "<method>", "which method to trace", Kind.String, new F<Object>() {
          @Override
          public void f(Object s) {
            Control.addTrace((String) s);
            return;
          }
        }), new Arg<Object>("verbose", "{0|1|2}", "how verbose to be", Kind.Int, new F<Object>() {
          @Override
        ...
        }), new Arg<Object>("visualize", "<bmp|pdf|ps|jpg>", "to visualize a graph", Kind.String, new F<Object>() {
          @Override
          public void f(Object ss) {
            String s = (String) ss;
            if (s.equals("bmp")) {
